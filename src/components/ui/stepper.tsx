...
interface StepperContextValue {
  stepper: ReturnType<ReturnType<typeof Stepperize.defineStepper<StepDefinition[]>>["useStepper"]>
...
function Stepper({
  ...
  const stepperDefRef = useRef<ReturnType<typeof Stepperize.defineStepper<StepDefinition[]>> | null>(null)
