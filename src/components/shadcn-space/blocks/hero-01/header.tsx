...
import { PRODUCT_ICONS, PRODUCT_ICON_STYLE } from "./product-icons";
...
/**
 * Ikona + rang xaritasi `product-icons.tsx` da (YAGONA manba — "Mahsulotlar"
 * boʻlimi ham shundan oʻqiydi). Bu yerda faqat qator-hover uslubi qoladi.
 *
 ...
 * uslubi). Landing'ning yagona rangli joyi — atayin, mono qoida shu yerda
 * ongli ravishda buziladi.
 */
...
const PRODUCT_ROW_HOVER_STYLE: Record<(typeof PRODUCTS)[number]["slug"], string> = {
  blog: "hover:bg-slate-100 dark:hover:bg-slate-500/10 hover:[&_.tile-label]:text-slate-700 dark:hover:[&_.tile-label]:text-slate-200 hover:[&_.tile-arrow]:text-slate-600 dark:hover:[&_.tile-arrow]:text-slate-300",
