        ...
        <section>
            <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 md:py-20 py-8">
                <div className="bg-teal-400/20 py-24 relative overflow-hidden">
                    <img src="https://images.shadcnspace.com/assets/svgs/newsletter-flake.svg" alt="newsletter-flake" className="absolute animate-spin [animation-duration:3000ms] w-80 h-80 -top-2/4 right-0 -z-1" />
                    <div className="flex flex-col gap-10 relative z-0">
                        <div className="flex flex-col gap-6 text-center">
                            ...
                            <p className="text-base text-muted-foreground max-w-xl mx-auto animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-200 ease-in-out fill-mode-both">
                                Baholash, oʻzlashtirish va tizim imkoniyatlari boʻyicha foydali maslahatlarni
                                toʻgʻridan-toʻgʻri pochtangizga olib boring.
                            </p>
                        </div>
                    ...
                    <img src="https://images.shadcnspace.com/assets/svgs/newsletter-flake.svg" alt="newsletter-flake" className="absolute animate-spin [animation-duration:3500ms] top-1/3 -z-1" />
                </div>
            </div>
        </section>
    );
