...
/** Lazer koʻrsatkich — solar:magic-stick-3-bold-duotone (nur sochuvchi tayoqcha) */
export function IconLaser({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={cn("doska-icon", className)} aria-hidden="true">
      <path opacity=".5" d="M3.845 3.845a2.883 2.883 0 0 0 0 4.077L5.432 9.51c.012-.014.555.503.568.49l4-4c.013-.013-.504-.556-.49-.568L7.922 3.845a2.883 2.883 0 0 0-4.077 0m1.288 11.462a.483.483 0 0 1 .9 0l.157.4a.48.48 0 0 0 .272.273l.398.157a.486.486 0 0 1 0 .903l-.398.158a.48.48 0 0 0-.272.273l-.157.4a.483.483 0 0 1-.9 0l-.157-.4a.48.48 0 0 0-.272-.273l-.398-.158a.486.486 0 0 1 0-.903l.398-.157a.48.48 0 0 0 .272-.274z"/>
      <path opacity=".2" d="M19.967 9.13a.483.483 0 0 1 .9 0l.156.399c.05.125.148.224.273.273l.398.158a.486.486 0 0 1 0 .902l-.398.158a.5.5 0 0 0-.273.273l-.156.4a.483.483 0 0 1-.9 0l-.157-.4a.5.5 0 0 0-.272-.273l-.398-.158a.486.486 0 0 1 0-.902l.398-.158a.5.5 0 0 0 .272-.273z"/>
      <path opacity=".7" d="M16.1 2.307a.483.483 0 0 1 .9 0l.43 1.095a.48.48 0 0 0 .272.274l1.091.432a.486.486 0 0 1 0 .903l-1.09.432a.5.5 0 0 0-.273.273L17 6.81a.483.483 0 0 1-.9 0l-.43-1.095a.5.5 0 0 0-.273-.273l-1.09-.432a.486.486 0 0 1 0-.903l1.09-.432a.5.5 0 0 0 .273-.274z"/>
...
/**
 * Lasso — OʻZIMIZ CHIZGAN.
 *
 * Yozuv atrofidagi halqa va uning dumi. Kursor yoki toʻrtburchak
 * belgilash EMAS — «Tanlash» (vidjet) bilan adashmasin.
 */
export function IconLasso({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={cn("doska-icon", className)} aria-hidden="true">
      <g>
        <path fillRule="evenodd" clipRule="evenodd" opacity=".5" d="M12 3C6.75 3 2.5 6.13 2.5 10s4.25 7 9.5 7 9.5-3.13 9.5-7S17.25 3 12 3Zm0 1.75c-4.45 0-7.75 2.6-7.75 5.25S7.55 15.25 12 15.25 19.75 12.65 19.75 10 16.45 4.75 12 4.75Z" />
        <circle cx="7" cy="16.25" r="2.75" />
        <path d="M5.82 18.2a.75.75 0 0 1 1.23.86c-.62.88-.66 1.62-.24 2.33a.75.75 0 1 1-1.29.76c-.73-1.23-.6-2.6.3-3.95Z" />
      </g>
    </svg>
  );
}

/** Chizgʻich — solar:ruler-bold-duotone */
export function IconRuler({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={cn("doska-icon", className)} aria-hidden="true">
      <g><path d="M2 15.6157C2 16.463 2.68179 17.1448 4.04537 18.5083L5.49167 19.9546C6.85525 21.3182 7.53704 22 8.38426 22C9.23148 22 9.91327 21.3182 11.2769 19.9546L19.9546 11.2769C21.3182 9.91327 22 9.23148 22 8.38426C22 7.53704 21.3182 6.85525 19.9546 5.49167L18.5083 4.04537C17.1448 2.68179 16.463 2 15.6157 2C14.8623 2 14.2396 2.53926 13.1519 3.61778L12.1026 4.66595L11.0299 5.73861L9.98125 6.78726L8.90859 7.85993L7.85993 8.90859L6.78727 9.98125L5.73861 11.0299L4.66595 12.1026L3.61778 13.1519C2.53926 14.2396 2 14.8623 2 15.6157Z" opacity=".5"/><path d="M13.2377 3.69124C13.2107 3.66423 13.1821 3.63971 13.1523 3.61768L12.103 4.66584C12.1251 4.6959 12.1498 4.72469 12.177 4.7519L13.5912 6.16612C13.8841 6.45901 14.359 6.45901 14.6519 6.16612C14.9448 5.87322 14.9448 5.39835 14.6519 5.10546L13.2377 3.69124Z"/><path d="M11.1164 5.81256C11.0891 5.78535 11.0604 5.76066 11.0303 5.73851L9.98164 6.78716C10.0038 6.81722 10.0285 6.84601 10.0557 6.87322L12.177 8.99454C12.4699 9.28744 12.9448 9.28744 13.2377 8.99454C13.5306 8.70165 13.5306 8.22678 13.2377 7.93388L11.1164 5.81256Z"/><path d="M8.99503 7.93388C8.96782 7.90667 8.93903 7.88198 8.90897 7.85983L7.86031 8.90848C7.88247 8.93854 7.90716 8.96733 7.93437 8.99454L9.34859 10.4088C9.64148 10.7017 10.1164 10.7017 10.4092 10.4088C10.7021 10.1159 10.7021 9.64099 10.4092 9.3481L8.99503 7.93388Z"/><path d="M6.87371 10.0552C6.8465 10.028 6.81771 10.0033 6.78765 9.98115L5.73899 11.0298C5.76115 11.0599 5.78584 11.0886 5.81305 11.1159L7.93437 13.2372C8.22726 13.5301 8.70214 13.5301 8.99503 13.2372C9.28792 12.9443 9.28792 12.4694 8.99503 12.1765L6.87371 10.0552Z"/><path d="M4.75239 12.1765C4.72518 12.1493 4.69639 12.1246 4.66633 12.1025L3.61816 13.1518C3.6402 13.1816 3.66472 13.2102 3.69173 13.2372L5.10594 14.6514C5.39884 14.9443 5.87371 14.9443 6.16661 14.6514C6.4595 14.3585 6.4595 13.8836 6.16661 13.5907L4.75239 12.1765Z"/></g>
    </svg>
  );
}

/**
 * Transportir — OʻZIMIZ CHIZGAN (Solar toʻplamida yoʻq).
 *
 * Yarim doira (massa) va unda besh shkala chizigʻi, markaz nuqtasi
 * (detal) — chizgʻich ikonasi bilan bir oilada.
 */
export function IconProtractor({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={cn("doska-icon", className)} aria-hidden="true">
      <g>
        <path opacity=".5" d="M2 17.5a10 10 0 0 1 20 0v.75c0 .41-.34.75-.75.75H2.75a.75.75 0 0 1-.75-.75z" />
        {[-60, -30, 0, 30, 60].map((a) => (
          <rect key={a} x="11.25" y="8.5" width="1.5" height="3" rx=".75" transform={`rotate(${a} 12 17.5)`} />
        ))}
...
/** Rasm qilib saqlash — solar:gallery-download-bold-duotone */
export function IconImageDownload({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={cn("doska-icon", className)} aria-hidden="true">
      <g><path d="M21.9998 12.6978C21.9983 14.1674 21.9871 15.4165 21.9036 16.4414C21.8067 17.6308 21.6081 18.6246 21.1636 19.45C20.9676 19.814 20.7267 20.1401 20.4334 20.4334C19.601 21.2657 18.5405 21.6428 17.1966 21.8235C15.8835 22 14.2007 22 12.0534 22H11.9466C9.79929 22 8.11646 22 6.80345 21.8235C5.45951 21.6428 4.39902 21.2657 3.56664 20.4334C2.82871 19.6954 2.44763 18.777 2.24498 17.6376C2.04591 16.5184 2.00949 15.1259 2.00192 13.3967C2 12.9569 2 12.4917 2 12.0009V11.9466C1.99999 9.79929 1.99998 8.11646 2.17651 6.80345C2.3572 5.45951 2.73426 4.39902 3.56664 3.56664C4.39902 2.73426 5.45951 2.3572 6.80345 2.17651C7.97111 2.01952 9.47346 2.00215 11.302 2.00024C11.6873 1.99983 12 2.31236 12 2.69767C12 3.08299 11.6872 3.3952 11.3019 3.39561C9.44749 3.39757 8.06751 3.41446 6.98937 3.55941C5.80016 3.7193 5.08321 4.02339 4.5533 4.5533C4.02339 5.08321 3.7193 5.80016 3.55941 6.98937C3.39683 8.19866 3.39535 9.7877 3.39535 12C3.39535 12.2702 3.39535 12.5314 3.39567 12.7844L4.32696 11.9696C5.17465 11.2278 6.45225 11.2704 7.24872 12.0668L11.2392 16.0573C11.8785 16.6966 12.8848 16.7837 13.6245 16.2639L13.9019 16.0689C14.9663 15.3209 16.4064 15.4076 17.3734 16.2779L20.0064 18.6476C20.2714 18.091 20.4288 17.3597 20.5128 16.3281C20.592 15.3561 20.6029 14.1755 20.6044 12.6979C20.6048 12.3126 20.917 12 21.3023 12C21.6876 12 22.0002 12.3125 21.9998 12.6978Z" opacity=".5"/><path fillRule="evenodd" d="M17.5 2C15.3787 2 14.318 2 13.659 2.65901C13 3.31802 13 4.37868 13 6.5C13 8.62132 13 9.68198 13.659 10.341C14.318 11 15.3787 11 17.5 11C19.6213 11 20.682 11 21.341 10.341C22 9.68198 22 8.62132 22 6.5C22 4.37868 22 3.31802 21.341 2.65901C20.682 2 19.6213 2 17.5 2ZM19.5303 7.53033L18.0303 9.03033C17.7374 9.32322 17.2626 9.32322 16.9697 9.03033L15.4697 7.53033C15.1768 7.23744 15.1768 6.76256 15.4697 6.46967C15.7626 6.17678 16.2374 6.17678 16.5303 6.46967L16.75 6.68934V4.5C16.75 4.08579 17.0858 3.75 17.5 3.75C17.9142 3.75 18.25 4.08579 18.25 4.5V6.68934L18.4697 6.46967C18.7626 6.17678 19.2374 6.17678 19.5303 6.46967C19.8232 6.76256 19.8232 7.23744 19.5303 7.53033Z" clipRule="evenodd"/></g>
    </svg>
  );
}
...
export const DOSKA_ICONS: { name: string; source: string; Icon: React.ComponentType<{ className?: string }> }[] = [
  ...
  { name: "IconLaser", source: "solar:magic-stick-3", Icon: IconLaser },
  { name: "IconLasso", source: "oʻzimiz:lasso", Icon: IconLasso },
  { name: "IconRuler", source: "solar:ruler", Icon: IconRuler },
  { name: "IconProtractor", source: "oʻzimiz:transportir", Icon: IconProtractor },
  { name: "IconImageDownload", source: "solar:gallery-download", Icon: IconImageDownload },
