...
export function AuthShell({
  ...
  return (
    <div className={cn("grid h-svh min-h-0", showFeatureLoop && "lg:grid-cols-2")}>
      <div className="scrollbar-thin flex h-svh min-h-0 flex-col gap-4 overflow-y-auto p-6 md:p-10">
