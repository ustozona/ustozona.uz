...
import { CLASS_COLOR_BASE, makeColorTints } from "@/lib/class-colors";
import { ProgressiveBlur } from "@/components/ui/progressive-blur";
import type { FeatureLoopItem } from "./FeatureLoop";

const CARD_STEP = 92;
const CARD_HEIGHT = 84;

/* ════════════════════════════════════════════════════════════════════
   AUTH FEATURE LOOP — login/register/forgot-password/reset-password
   foni uchun cheksiz aylanuvchi "steksimon" roʻyxat (progress-chiziq +
   yorqinroq kartalar). ONBOARDING'dagi FeatureLoop'dan ATAYLAB AJRATILGAN
   — ikkalasi bir komponent boʻlganda auth uchun qilingan oʻzgarish
   onboarding welcome kartasiga ham sizib oʻtgan edi (2026-07-15 bug).
   ════════════════════════════════════════════════════════════════════ */
export function AuthFeatureLoop({
  items,
  duration = 4200,
  visible = 3,
  className,
