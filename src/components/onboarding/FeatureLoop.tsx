...
/* ════════════════════════════════════════════════════════════════════
   ...
   Auth sahifalari (login/register/parolni tiklash) OʻZINING alohida
   AuthFeatureLoop komponentidan foydalanadi — ataylab ajratilgan,
   bittasidagi oʻzgarish ikkinchisiga sizib oʻtmasin (2026-07-15 bug).
   ════════════════════════════════════════════════════════════════════ */
