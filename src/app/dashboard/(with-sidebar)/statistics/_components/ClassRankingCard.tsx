...
/** Sinflarni bitta koʻrsatkich (davomat yoki oʻzlashtirish %) boʻyicha
    eng past → eng yuqori tartibda saralaydi — maktab boʻyicha domen
          ...
          return (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <Progress value={r.value ?? 0} className="mt-1.5 h-1.5" />
              </div>
