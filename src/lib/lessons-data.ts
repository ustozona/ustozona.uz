...
export const UNITS: Unit[] = [
  ...
  { id: "u5", classId: "7-a", number: 1, title: "Salomlashish va tanishuv (Greetings)", description: "Kundalik muloqotda salomlashish, oʻzini tanishtirish va xushmuomalalik iboralari." },
  { id: "u6", classId: "7-a", number: 2, title: "Oila va doʻstlar (Family & Friends)", description: "Oila aʼzolari, egalik olmoshlari va kishilarni tasvirlash uchun soʻz boyligi." },
  { id: "u7", classId: "7-a", number: 3, title: "Kundalik mashgʻulotlar (Present Simple)", description: "Present Simple yordamida kundalik ish-harakatlar va vaqtni ifodalash." },
  { id: "u8", classId: "7-a", number: 4, title: "Sevimli mashgʻulotlar (Hobbies)", description: "Hobbi va qiziqishlar haqida gapirish, like / donʼt like konstruksiyalari." },
  { id: "u9", classId: "9-a", number: 1, title: "Oʻqish koʻnikmasi (Reading)", description: "Matnni tushunib oʻqish, asosiy gʻoyani topish va yangi soʻzlarni kontekstdan aniqlash." },
  { id: "u10", classId: "9-a", number: 2, title: "Yozish koʻnikmasi (Writing)", description: "Norasmiy xat va qisqa insho yozish, paragraf tuzilishi va bogʻlovchilar." },
  { id: "u11", classId: "5-a", number: 1, title: "Salomlashish va tanishuv (Greetings)", description: "Kundalik muloqotda salomlashish, oʻzini tanishtirish va xushmuomalalik iboralari." },
  { id: "u12", classId: "5-a", number: 2, title: "Alifbo va sonlar (Alphabet & Numbers)", description: "Inglizcha alifbo, sonlarni oʻqish va yozish, oddiy heceleme mashqlari." },
  { id: "u13", classId: "5-a", number: 3, title: "Oila va doʻstlar (Family & Friends)", description: "Oila aʼzolari, egalik olmoshlari va kishilarni tasvirlash uchun soʻz boyligi." },
  { id: "u14", classId: "8-a", number: 1, title: "Sayohat va transport (Travel)", description: "Transport turlari, yoʻnalish soʻrash va sayohat rejalari haqida soʻz boyligi." },
  { id: "u15", classId: "8-a", number: 2, title: "Past Simple: oʻtgan voqealar", description: "Past Simple yordamida oʻtgan zamon voqealarini hikoya qilish." },
  { id: "u16", classId: "8-a", number: 3, title: "Ekologiya va atrof-muhit (Environment)", description: "Atrof-muhit muammolari haqida fikr bildirish, modal feʼllar (should/must)." },
];
...
export const LESSONS: Lesson[] = [
  ...
  { id: "l6", classId: "7-a", unitId: "u5", number: 1, title: "Salomlashish iboralari va tanishuv", status: "Completed", date: "Sep 5", time: "9:00 AM", classCount: 1 },
  { id: "l7", classId: "7-a", unitId: "u6", number: 1, title: "Oila aʼzolari va egalik olmoshlari", status: "Completed", date: "Sep 12", time: "9:00 AM", classCount: 1 },
  { id: "l8", classId: "7-a", unitId: "u7", number: 1, title: "Present Simple: kundalik ishlar", status: "Unscheduled", classCount: 2 },
  { id: "l9", classId: "7-a", unitId: "u7", number: 2, title: "Present Simple: savol va inkor shakllari", status: "Draft" },
  // 9-B Ingliz tili — standartlarga bogʻlangan (Faza 3: dars→qamrov avto demo).
  { id: "l10", classId: "9-a", unitId: "u9", number: 1, title: "Matnni oʻqib tushunish: asosiy gʻoya", status: "Completed", date: "Sep 8", time: "11:00 AM", classCount: 1, standards: ["R.01", "R.02"] },
  { id: "l11", classId: "9-a", unitId: "u10", number: 1, title: "Norasmiy xat yozish", status: "Completed", date: "Sep 15", time: "11:00 AM", classCount: 1, standards: ["W.01"] },
  { id: "l12", classId: "5-a", unitId: "u11", number: 1, title: "Salomlashish iboralari va tanishuv", status: "Completed", date: "Sep 5", time: "8:50 AM", classCount: 1 },
  { id: "l13", classId: "5-a", unitId: "u12", number: 1, title: "Alifboni takrorlash", status: "Completed", date: "Sep 12", time: "8:50 AM", classCount: 1 },
  { id: "l14", classId: "5-a", unitId: "u13", number: 1, title: "Oila aʼzolarini tanishtirish", status: "Unscheduled", classCount: 1 },
  { id: "l15", classId: "5-a", unitId: "u13", number: 2, title: "Egalik olmoshlari mashqi", status: "Draft" },
  { id: "l16", classId: "8-a", unitId: "u14", number: 1, title: "Transport turlari va yoʻnalishlar", status: "Completed", date: "Sep 6", time: "1:00 PM", classCount: 1 },
  { id: "l17", classId: "8-a", unitId: "u15", number: 1, title: "Past Simple: toʻgʻri feʼllar", status: "Completed", date: "Sep 13", time: "1:00 PM", classCount: 1 },
  { id: "l18", classId: "8-a", unitId: "u16", number: 1, title: "Ekologiya: soʻz boyligi", status: "Unscheduled", classCount: 1 },
];
