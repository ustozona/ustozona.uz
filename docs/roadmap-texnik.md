...
|---|---|---|---|
| Prod-tayyorlik | Kod tayyor: Google OAuth env-gated, `npm run db:seed` mavjud | 🟢 2026-07-14: domen ULANGAN (asosiy = www.ustozona.uz, apex 308→www, NS ahost.uz), seed YURITILDI (15 sinf/216 oʻquvchi/14762 davomat), health+login API ikkala domenda 200+cookie. Qoldi: telefon-qurilma testi (user), Google OAuth env (user, ixtiyoriy) | **S** |
