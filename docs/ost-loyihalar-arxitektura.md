...
**Qoldi:** R213/R214 ijrosi (test tanlanganda topshiriq darhol yaratilsin; `publishSessionToGrades` topshiriq **yaratmasin**, mavjudini **toʻldirsin**), R216 (maks. ball avtomatik + faqat oʻqish), R217/R219 (`Lesson.subject` + `Lesson.grade`, `units` shu bilan birga), R220 (`mode` oʻqlarga ajratilsin). Nomlash: jurnal ustuni = "Topshiriq", hozirgi *Topshiriqlar* sahifasi (mazmun uyi) boshqa nom oladi — **hal qilinmagan**.
